...
#ADD $SRC_JAR app.jar
ADD build/libs/spring-mongodb-client-1.0.jar spring-mongodb-client-1.0.jar

# APP_PORTS is passed in --build-arg
#EXPOSE $APP_PORTS
EXPOSE 8080

ENTRYPOINT ["java","-Djava.io.tmpdir=/tmp","-Djava.security.egd=file:/dev/./urandom","-jar","spring-mongodb-client-1.0.jar","-dcv"]
